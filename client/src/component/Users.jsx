    ...
    return(
        <div style={{width:"100vw",height:"100vh",display:"flex",alignItems:"center",flexDirection:"column",justifyContent:"center"}}>
            ...
            <div style={{width:"100%",height:"100%",display:"flex",flexWrap:"wrap",gap:"20px"}}>
                {data.map((user)=>{
                    return(
                        <table style={{width:"23%",height:"50%",border:"2px solid black",borderRadius:"10px"}}>
                            <tr>
                            ...
                            <tr>
                                <td colSpan={2} align="center">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore cumque perferendis molestias officiis mollitia eius officia saepe voluptatem voluptates reiciendis!</td>
                            </tr>
                            <tr>
